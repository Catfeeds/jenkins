...
public class UserController{
	...
	@ResponseBody
	@MjPermission
	public WebResponse deleteUserPer(@PathVariable("userId")String userId)throws Exception {
		iUserService.deleteUserPer(userId);
		return new WebResponse();
	}
	...
	@ResponseBody
	@MjPermission
	public WebResponse deleteUserCom(@PathVariable("companyId")String companyId)throws Exception {
		iUserService.deleteUserCom(companyId);
		return new WebResponse();
	}
}
