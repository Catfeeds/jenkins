package com.hfocean.uavportal.console.system.service.impl;
...
import com.hfocean.uavportal.auth.fishsea.mapper.UserOrgRefMapper;
import com.hfocean.uavportal.auth.fishsea.pojo.SysUserPO;
import com.hfocean.uavportal.auth.fishsea.pojo.UserOrgRef;
import com.hfocean.uavportal.auth.system.org.dao.ISysOrgDao;
import com.hfocean.uavportal.auth.system.user.dao.ISysUserDao;
import com.hfocean.uavportal.auth.system.user.dao.UserOrgRefDao;
...
import com.hfocean.uavportal.auth.util.StringUtil;
import com.hfocean.uavportal.console.system.exception.BusinessException;
...
public class SysUserServiceImpl implements ISysUserService {
	...
	public SysUserVO updateUser(UserUpdate user)  {
        ...
        if(orgId!=null){
            ...
            if(VerdictUtil.isValidCollection(userOrgRefMapper.findUserOrgRefList(userName))){
