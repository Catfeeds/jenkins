...
//		Login login = method.getMethodAnnotation(Login.class);
		...
		session.setOpenId("o_7HpwAkamEDQUQ1iON0cMH7qc-I");
		session.setType(2);
		session.setUserId("59573ec16bdceb3840cfce3f");
		session.setUserName("a123");
		WechatAppContextHelper.setCurrentUser(session);
		WechatAppContextHelper.setOpenId("o_7HpwAkamEDQUQ1iON0cMH7qc-I");
//		if (login != null){
//			//登录拦截
//			loginValidate();
//			//权限拦截
