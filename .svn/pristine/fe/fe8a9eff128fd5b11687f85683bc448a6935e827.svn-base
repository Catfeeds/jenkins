...
public interface IUserServiceCore extends BaseService<UserPersonalPO,String> {
	...
	int updateUserPerAuth(String userId, UserPerUpdateAuthParam param)throws Exception;
	
	int updateUserComAuth(String userId, UserComUpdateAuthParam param)throws Exception;
}
