...
//	}
	...
	@ResponseBody
	@Login
	public WebResponse updateUserAuth(UserPerUpdateAuthParam param)throws Exception {
		ValidateUtil.validate(param);
		WebSessionUser<?> currentUser = WebAppContextHelper.getCurrentUser();
	...
	@ResponseBody
	@Login
	public WebResponse updateComUserAuth(UserComUpdateAuthParam param)throws Exception {
		ValidateUtil.validate(param);
		WebSessionUser<?> currentUser = WebAppContextHelper.getCurrentUser();
