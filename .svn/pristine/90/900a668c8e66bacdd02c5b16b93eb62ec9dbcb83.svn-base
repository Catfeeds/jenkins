...
Ext.define('Rich.view.flight.FlightDetail',{
    ...
    setV:function(rec){
    	...
    	this.lookupI('landingInfo').applyValue(Ext.decode(rec.landingInfo));
    	...
    	switch(rec.type){//现场的数据
    		case 0:
    			...
    			danwei.setValue(contact.unitContactName);
    			danwei.show();
	    		var danweiph = this.lookupI('danweiph');
	    		danweiph.setValue(contact.unitContactPhone);
	    		danweiph.show();
