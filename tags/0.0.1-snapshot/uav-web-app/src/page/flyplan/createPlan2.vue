            ...
            <el-form ref="flyplan" label-position="left" :model="flyplan" :rules="rules"
                ...
                <div class="plan-form-content">
                    ...
                    <el-form-item label="计划空域及高度" prop="airInfo">
                        ...
                        <div style="color:red;"><span>真高：{{flyplan.airInfo[0].high}}米(含以下)</span></div>
                    </el-form-item>
    ...
    export default{
        ...
        computed: {
            ...
            seletableProvince: function () {
                var provinces = [];
                this.$store.state.airspaces.forEach(function (airspace, i) {
            ...
            seletableCities: function () {
                ...
                var cities = [];
                this.$store.state.airspaces.forEach(function (v, i) {
            ...
            if (flyCode != undefined) {
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        var airspace = this.$store.state.airspaces.find(function (value) {
