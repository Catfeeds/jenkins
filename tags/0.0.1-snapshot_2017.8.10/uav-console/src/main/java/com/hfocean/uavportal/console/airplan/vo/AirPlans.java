...
//    @ManyToMany
//    @JoinTable(name = "tb_plan_airspace_ref",joinColumns = @JoinColumn(name = "plan_id"),inverseJoinColumns = @JoinColumn(name = "airspace_id"))
//    private Set<AirspacePO> airspaces;
...
//    public Set<AirspacePO> getAirspaces() {
//        return airspaces;
//    }

//    public void setAirspaces(Set<AirspacePO> airspaces) {
